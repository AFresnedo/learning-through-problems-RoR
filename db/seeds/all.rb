...
# Graphs
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/FALSEHYP/falsehyp11.html
p = Problem.create!(filename: 'falsehyp11.html', curriculum: 'lifetomath', category: 'methods', context: 'falsehyp', text: "<p>We have 30 beams of wood of length either 3 or 5 meters, having a total length of 100 meters. How many cuts do\r\nwe have to make to turn all of them into beams of length\r\n1 meter? (Each cut acts on one beam only.)\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "70", interface: "You have to make [ ] cuts. ")
...
s.hints.create!(text: "How many 3-meter long beams are there?\r\n")
#HINT TUPLE FOR SOLUTION S
s.hints.create!(text: "How many times do you cut a 3-meter long beam?\r\n")
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 2, source: "Moscow Math Olympiad 1999-2000, rookies, modified")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/FALSEHYP/falsehyp7.html
p = Problem.create!(filename: 'falsehyp7.html', curriculum: 'lifetomath', category: 'methods', context: 'falsehyp', text: "<p>A person wants to mail one heavy, large envelope, and a total of 6  medium and small envelopes. The person\r\npaid 3.8 dollars at the cashier, and received a stamp for the large envelope, and 50-cent and 30-cent stamps\r\nfor the medium and small envelopes. The cost of the stamp for \r\nthe large envelope was by 1 dollar less than the total cost of the other  6 stamps.  How many small envelopes did the person mail?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "3", interface: "The person mailed [ ] small envelopes. ")
#SOLUTION TUPLE FOR PROBLEM P
s = p.solutions.create!(typ: "falsehyp", text: "<p>Building on what we have learned before, we use the graphical method to represent the \r\namounts of money paid for the large envelope (as one segment), and for the other envelopes: \r\n</p>\r\n<img src=\"FIGS/stamps.gif\" alt=\"The cost of stamps\"  width=\"250\" height=\"70\"><br>\r\n<p>\r\nIf we remove the 1 dollar then we see that two segments stand for 2.8, so one segment stands for 1.4 dollars.\r\nThis is the cost of the stamp for the large envelope. The\r\nother stamps cost \\(1.4+1=2.4\\) dollars.\r\n</p>\r\n<p>\r\nThe question is how can we write 2.4 dollars as a sum of 6 terms, some of which are 0.5 and\r\nsome are 0.3?\r\nIf all 6 envelopes are medium, the stamps would cost \\(6\\times 0.50=3\\) dollars, which is too\r\nmuch. We notice that each time we replace one medium envelope by one small envelope, the price\r\ndrops by 0.2 dollars. For the price to drop by \\(3-2.4=0.6\\) dollars, we need to replace 3 envelopes.\r\nSo the person mailed  <font color=\"red\">3</font> small envelopes. \r\n</p>\r\n")
#HINT TUPLE FOR SOLUTION S
s.hints.create!(text: "Represent the price of the stamp for the large envelope\r\nby a line segment. Then how do you represent the price of\r\nthe other 6 envelopes?\r\n")
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 2, source: "After Calugaru's Notes, GM 3102, 1968/12")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/FALSEHYP/falsehyp14.html
p = Problem.create!(filename: 'falsehyp14.html', curriculum: 'lifetomath', category: 'methods', context: 'falsehyp', text: "<p>\r\nAll of the 25 students in one class play either chess or\r\ngo. We know that 15 students play chess and 16 play go. How many\r\nstudents play chess but don't play go? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "9", interface: "There are [ ] students who play chess but don't play go. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/FALSEHYP/falsehyp4.html
p = Problem.create!(filename: 'falsehyp4.html', curriculum: 'lifetomath', category: 'methods', context: 'falsehyp', text: "<p>\r\nIn a computer game, for each red brick that I hit I\r\nget 25 points, and for each blue brick that I hit I get\r\n16 points. If I have hit 20 bricks and gained \r\n455 points, how many blue bricks did I hit?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "5", interface: "I hit [ ] blue bricks. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 1, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/FALSEHYP/falsehyp2.html
p = Problem.create!(filename: 'falsehyp2.html', curriculum: 'lifetomath', category: 'methods', context: 'falsehyp', text: "<p>\r\nAfter producing the  camera for a space telescope, the scientists\r\nwere told that its weight had to be reduced by 10%. \r\nOnce its weight was reduced, they added an optical device\r\nwhose weight was 12% of the weight of the camera. The weight\r\nof the entire ensemble had to be reduced by 4% so as to fit the\r\nadmissible weight of 48.384 kilograms. What\r\nwas the initial weight of the camera?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "50", interface: "The initial weight of the camera was [ ] kilograms. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#HINT TUPLE FOR SOLUTION S
s.hints.create!(text: "Put the students who took part in  the mathematics and physics Olympiads into one group. Now you have two groups:\r\nmathematics+physics with 39 students, and chemistry with 12 students. \r\n")
#HINT TUPLE FOR SOLUTION S
s.hints.create!(text: "What is the overlap of the two groups?\r\n")
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/FALSEHYP/falsehyp9.html
p = Problem.create!(filename: 'falsehyp9.html', curriculum: 'lifetomath', category: 'methods', context: 'falsehyp', text: "<p> To buy a book a student pays 200 dollars. He receives the\r\nchange as one fourth of the price of the book and an additional\r\n5 dollars. Knowing that he has received the change in \r\n1-dollar and 5-dollar bills, and that he has received a total of\r\n20 bills, find out how many 1-dollar bills did he receive. \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "14", interface: "He received [ ] 5-dollar bills. ")
#SOLUTION TUPLE FOR PROBLEM P
s = p.solutions.create!(typ: "falsehyp", text: "<p>\r\nWe start the solution with an application of the comparison\r\nmethod. The change is equal to \\(\\frac{1}{4}\\) of the price\r\nof the book plus 5 dollars. So the price of the book\r\nplus \\(\\frac{1}{4}\\) times the price of the book plus 5 dollars\r\nequals 200 dollars. Thus \\(1+\\frac{1}{4}=\\frac{5}{4}\\) times the\r\nprice of the book equals \\(200-5=195\\). So the price\r\nof the book is \\(\\frac{4}{5}\\times 195=156\\) dollars. Thus\r\nthe change is \\(200-156=44\\) dollars.\r\n</p>\r\n\r\n<p>\r\nNow we employ the method of false hypothesis. Had he  used\r\njust 1-dollar bills, he would have received only 20 dollars. For\r\nevery 1-dollar bill that you replace by a 5-dollar bill, the\r\namount grows by \\(5-1=4\\) dollars. So we have to replace\r\n\\(\\frac{44-20}{4}=\\frac{24}{4}=6\\) 1-dollar bills. Thus\r\nthe number of 1-dollar bills that he received is \\(20-6=\\color{red}{14}\\) dollars. \r\n</p>\r\n")
#HINT TUPLE FOR SOLUTION S
s.hints.create!(text: "Use the comparison method to find the value of the change that the student has received. \r\n")
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 3, source: "Petrica, Stefan, Alexe")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/FALSEHYP/falsehyp12.html
p = Problem.create!(filename: 'falsehyp12.html', curriculum: 'lifetomath', category: 'methods', context: 'falsehyp', text: "<p> One day a kiosk sold 50 magazines, some worth 3 dollars each\r\nand some worth 4 dollars each, making a total of 170 dollars. How\r\nmany magazines of each type did the kiosk sell?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "30|20", interface: "The kiosk sold [ ] 3-dollar magazines and [ ] 4-dollar magazines. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 1, source: "GM 3279 1969/8")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/FALSEHYP/falsehyp10.html
p = Problem.create!(filename: 'falsehyp10.html', curriculum: 'lifetomath', category: 'methods', context: 'falsehyp', text: "<p>\r\nA group of 24  people visited an amusement park.\r\n For the roller coaster\r\nthey paid a total of 352 dollars, at 22 dollars per person,\r\nand for the ferris wheel they paid 210 dollars, at 14 dollars\r\nper person.  They went on either the roller coaster, or\r\nthe ferries  wheel, or both.  Find out how many \r\npeople went on the ferris wheel but not on the roller coaster. \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "7", interface: "There were [ ]  people who went on the ferris wheel but not on the roller coaster. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 1, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/FALSEHYP/falsehyp8.html
p = Problem.create!(filename: 'falsehyp8.html', curriculum: 'lifetomath', category: 'methods', context: 'falsehyp', text: "<p>\r\nIn an apartment building there are 39 apartments, with 3 and 4 rooms. How many apartments of each type are there, if\r\nthe total number of rooms is 141?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "15|24", interface: "There are [ ] 3-room apartments and [ ] 4-room apartments. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 1, source: "Petrica, Stefan, Alexe")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/FALSEHYP/falsehyp5.html
p = Problem.create!(filename: 'falsehyp5.html', curriculum: 'lifetomath', category: 'methods', context: 'falsehyp', text: "<p>\r\nTwo kids went with the same amount of money to the store to buy  compact disks. The \r\nfirst kid bought them at 11.20 dollars a piece and was left with\r\n8 dollars, and the second bought them at 9.60 dollars a piece\r\nand was left with 4.80 dollars. Knowing that the second\r\nkid bought 2 compact disks more than the first, find \r\n how many compact disks\r\ndid each buy? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "10|12", interface: "The first kid bought [ ] compact disks and the second kid bought [ ] compact disks. ")
#SOLUTION TUPLE FOR PROBLEM P
s = p.solutions.create!(typ: "falsehyp", text: "<p>\r\nHad the second kid bought the same number of compact disks\r\nas the first, he would still have  \r\n\\begin{eqnarray*}\r\n2\\times 9.60+4.80=24 \\mbox{ dollars}\r\n\\end{eqnarray*}\r\nleft.\r\nSo, in the end,  he would have \\(16\\) dollars more than the first kid. \r\n\r\nThis difference comes from the fact that each disk that\r\nhe bought cost \\(11.20-9.60=1.60\\) dollars less than the\r\ndisks bought by the first kid. So the first kid bought\r\n\\begin{eqnarray*}\r\n\\frac{16}{1.6}=\\color{red}{10}\\mbox{ compact disks}.\r\n\\end{eqnarray*}\r\nThe second kid bought \\(10+2=\\color{red}{12}\\) compact disks.\r\n \r\n</p>\r\n")
#HINT TUPLE FOR SOLUTION S
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 2, source: "Gheba, modified")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/FALSEHYP/falsehyp3.html
p = Problem.create!(filename: 'falsehyp3.html', curriculum: 'lifetomath', category: 'methods', context: 'falsehyp', text: "<p>\r\nIrina read a 301 page novel in 7 days. Each day she read one page\r\nless than on the previous day. How many pages did Irina read\r\non  the first day?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "46", interface: "On the first day Irina read [ ] pages. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 3, source: "7steps 88 IMG1550 IMG1592")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/CASETRY/casetry7.html
p = Problem.create!(filename: 'casetry7.html', curriculum: 'lifetomath', category: 'methods', context: 'casetry', text: "<p>\r\nIn an office, at various times during the day \r\nthe boss gives the secretary a letter to type, each time putting \r\nthe letter on top of the pile in the secretary's inbox. When\r\nthere is time, the secretary takes the top letter in the pile and types it. If there are five letters at all, and the boss\r\ndelivers them in the order 1,2,3,4,5, which of the following\r\ncould <b>not</b> be the order in which the secretary types them?<br>\r\n(1) 1,2,3,4,5 &nbsp;(2) 2,4,3,5,1 &nbsp;(3) 3,2,4,1,5 &nbsp;(4) 4,5,2,3,1 &nbsp;(5) 5,4,3,2,1.\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "4", interface: "Pattern [ ] cannot be the  order in which the secretary typed the letters. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/BACKWARDS/backwards3.html
p = Problem.create!(filename: 'backwards3.html', curriculum: 'lifetomath', category: 'methods', context: 'backwards', text: "<p> A family has divided its montly income as follows: one half went on\r\nrent, one half of what was left went on food, one fourth of what\r\nwas left of this for utilities, and the rest of 750 dollars were\r\nleft in their bank account. What is the monthly income of\r\nthat family?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "4000", interface: "The montly income of the family is [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 1, source: "manual clasa a IV-a")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/BACKWARDS/backwards4.html
p = Problem.create!(filename: 'backwards4.html', curriculum: 'lifetomath', category: 'methods', context: 'backwards', text: "<p> The land of a farm was sown as follows: half of the land\r\nless  60 acres was sown with corn, then \\(\\frac{5}{8}\\) of the rest\r\nand another 100 acres was sown with soybeans. The remaing 80 acres was turned into pasture. What is the total surface of\r\nthe farm? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "840", interface: "The farm had [ ] acres of land. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#HINT TUPLE FOR SOLUTION S
s.hints.create!(text: " The 60 feet make up \\(\\frac{2}{3}\\) of what was left after\r\nwiring the first and second floors.\r\n")
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 2, source: "Gheba, modified")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/BACKWARDS/backwards5.html
p = Problem.create!(filename: 'backwards5.html', curriculum: 'lifetomath', category: 'methods', context: 'backwards', text: "<p> \r\nLinda has some amount of money. After doubling that amount, Linda spends 16 dollars. Then she doubles again\r\nthe remaining amount and spends 21 dollars. She doubles\r\nthe amount again, and spends 25 dollars. Now she has 5 dollars\r\nleft. What was the initial amount of money that Linda had?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "17", interface: "Linda started with [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
s = p.solutions.create!(typ: "backwards", text: "<p>\r\nAfter Linda doubled the amount the last time she had \\(5+25=30\\) dollars, thus before that she had \\(\\frac{30}{2}=15\\) dollars.\r\nAdding the 21 dollars to it, we see that after she doubled\r\nthe amount the second time, she had \\(15+21=36\\) dollars. So\r\n before doubling she had \\(\\frac{36}{2}=18\\) dollars.\r\nAdd to this 16 to get 34, which is the amount she had after\r\ndoubling the first time. So Linda started with   \\(\\frac{34}{2}=\r\n\\color{red}{17}\\) dollars. \r\n</p>\r\n")
#HINT TUPLE FOR SOLUTION S
s.hints.create!(text: "How much money did Linda have before doubling the amount for the last time?\r\n")
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 1, source: "Petrica, Stefan, Alexe")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/BACKWARDS/backwards6.html
p = Problem.create!(filename: 'backwards6.html', curriculum: 'lifetomath', category: 'methods', context: 'backwards', text: "<p> At the bakery at the moment of closing there were 4 buyers\r\nstill inside, who bought all the bread left. How many loaves\r\nof bread were still left at the time of closing, knowing that\r\nof the 4 buyers, each bought half of the bread that was available\r\nwhen their turn came plus one half of a loaf of bread? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "15", interface: "At the time of closing there were [ ] loaves of bread left. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 2, source: "Petrica, Stefan, Alexe")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/comparison/comparison8.html
p = Problem.create!(filename: 'comparison8.html', curriculum: 'lifetomath', category: 'methods', context: 'comparison', text: "<p> The students in one school bought 40 copies of the third edition of a text book, 150 copies of the second edition of that\r\ntext book, and 120 copies of the first edition of that text book, \r\nfor a total of 20320 dollars. Find how much does one book\r\nof each edition cost, if the third edition costs twice as\r\nmuch as the second edition, and the second edition costs \r\nfive times as much as the first. \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "160|80|16", interface: "One book of the first edition costs [ ] dollars, one book of the second edition costs [ ] dollars, and one book of the third edition costs [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 1, source: "Petrica, Stefan, Alexe, modified")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/comparison/comparison14.html
p = Problem.create!(filename: 'comparison14.html', curriculum: 'lifetomath', category: 'methods', context: 'comparison', text: "<p> There are 64 students split into two classes. If 3 students  moved from the first class to the second, then the first class would have 2 students more than the second. How many students are there in each class?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "36|28", interface: "In the first class there are [ ] students, in the second class there are [ ] students. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 3, source: "GM, 3/1984, from Petrica, Stefan, Alexe")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/comparison/comparison1.html
p = Problem.create!(filename: 'comparison1.html', curriculum: 'lifetomath', category: 'methods', context: 'comparison', text: "<p>\r\nSusan pays for 4 muffins and 3 bananas. Calvin spends twice as\r\nmuch paying for 3 muffins and 18 bananas. A muffin is how many\r\ntimes as expensive as a banana? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "2.4", interface: "A muffin is [ ] times as expensive as a banana. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 1, source: "AMC8, modified.")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/comparison/comparison12.html
p = Problem.create!(filename: 'comparison12.html', curriculum: 'lifetomath', category: 'methods', context: 'comparison', text: "<p>\r\nAlejandro has sold one month \r\n 255 copies of the game TYT, 320 copies of\r\nthe game UVU, and 101 copies of the game GRM that he had created,\r\nfor a total of 8480 dollars.    Next month he only sold \r\n220 copies of TYT, 160 copies of UVU, and 87 copies of GRM for\r\na total of 5805 dollars. Knowing that TYT is  2 dollars cheaper than UVU, find how much does each game cost?\r\n\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "11|13|15", interface: "TYT costs [ ] dollars, UVU costs [ ] dollars, while GRM costs [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 4, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/comparison/comparison4.html
p = Problem.create!(filename: 'comparison4.html', curriculum: 'lifetomath', category: 'methods', context: 'comparison', text: "<p> If 125 cows and 78 horses eat 2592 kilograms of hay per\r\nday and 109 cows and 78 horses eat 2400 kilograms of\r\nhay per day, how much does one cow and how much does one horse\r\neat per day?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "12|14", interface: "A cow eats [ ] kilograms of hay per day and  a horse eats [ ] kilograms of hay per day. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 2, source: "Petrica, Stefan, Alexe")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/comparison/comparison2.html
p = Problem.create!(filename: 'comparison2.html', curriculum: 'lifetomath', category: 'methods', context: 'comparison', text: "<p>\r\nDuring one month a plant produced  a total of 400 freezers and refrigerators. Next month it produced twice as many freezers\r\nand by \\(\\frac{3}{20}\\) more refrigerators, for a total of 715. \r\nHow many freezers and how many refrigerators did the plant produce each\r\nmonth?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "300|100|600|115", interface: "During the first month the plant produced [ ] freezers and [ ] refrigerators. During the second month, the plant produced [ ] freezers and [ ] refrigerators. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 2, source: "Calugaru")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/comparison/comparison9.html
p = Problem.create!(filename: 'comparison9.html', curriculum: 'lifetomath', category: 'methods', context: 'comparison', text: "<p>\r\nA singer sold 300 CD's and 500 DVD's of his last concert for\r\na total of 14200 dollars. For\r\nevery 3 CD's sold, he got by 2 dollars more than what he would\r\nhave got by selling 2 DVD's. How much does a CD and how much does\r\na DVD cost?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "14|20", interface: "A CD costs [ ] dollars, a DVD costs [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 3, source: "Calugaru, modified")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/PROPORTIONS/proportions23.html
p = Problem.create!(filename: 'proportions23.html', curriculum: 'lifetomath', category: 'methods', context: 'proportions', text: "<p>\r\nSuppose that 12 cows give 110 gallons of milk in 4 days. At this rate, how many gallons of milk will 5 cows give in 6 days?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 1, source: "AMC8, modified")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/PROPORTIONS/proportions17.html
p = Problem.create!(filename: 'proportions17.html', curriculum: 'lifetomath', category: 'methods', context: 'proportions', text: "<p>\r\nA team of workers loads  boxes filled with apples in trucks at a rate of 1240 boxes  every 5 hours. Another team of workers brings boxes filled with apples  from the orchard at a rate of\r\n285 every 45 minutes.\r\nKnowing that at the begining of the day there were 120 boxes\r\nleft at the loading zone from the day before, how many\r\nboxes will there be left at the end of the day if the length\r\nof the work day is 8 hours?     \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "216", interface: "At the end of the day there will be [ ] boxes left. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/PROPORTIONS/proportions15.html
p = Problem.create!(filename: 'proportions15.html', curriculum: 'lifetomath', category: 'methods', context: 'proportions', text: "<p>If one needs 25 people to pick 520 pounds of apples at an orchard during\r\nan 8 hour period, how many people are needed to pick 750 pounds of\r\napples during a 5 hour period?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "58", interface: "We need [ ] people. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#HINT TUPLE FOR SOLUTION S
s.hints.create!(text: "The answer cannot be a fraction of a person, to solve\r\nthe task you have to round up to the next whole number.\r\n")
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/PROPORTIONS/proportions22.html
p = Problem.create!(filename: 'proportions22.html', curriculum: 'lifetomath', category: 'methods', context: 'proportions', text: "<p>If a town in which live 480 people uses 2040 gallons of\r\nwater per day, how much water would it use if its\r\npopulation were to grow by 100 people? (Assume that\r\nthe amount of water used is proportional to the population.)\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "150", interface: "Six yards of fabric cost [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 1, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/PROPORTIONS/proportions21.html
p = Problem.create!(filename: 'proportions21.html', curriculum: 'lifetomath', category: 'methods', context: 'proportions', text: "<p>\r\nThe circumference of the front wheels of a lunar rover is \r\n140 centimeters while  the circumference of the back wheels\r\nof the rover is 165 centimeters. If the rover travels in\r\na straigh forward direction, at what distance from the start\r\nwould the front wheels have made 7 complete\r\n turns more than the back wheels? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "6468", interface: "The distance from the start is [ ] centimeters. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 3, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/PROPORTIONS/proportions9.html
p = Problem.create!(filename: 'proportions9.html', curriculum: 'lifetomath', category: 'methods', context: 'proportions', text: "<p>If it takes six hours for four pumps to remove the water\r\nfrom a basin, how long will it take for fifteen pumps to remove\r\nthe water from the same basin?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "1|36", interface: "It takes [ ] hours and  [ ] minutes to pump the water out of the basin. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 1, source: "")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/PROPORTIONS/proportions18.html
p = Problem.create!(filename: 'proportions18.html', curriculum: 'lifetomath', category: 'methods', context: 'proportions', text: "<p>\r\nA cogwheel has 30 teeth and makes 160 rotations per minute.\r\nAnother cogwheel that is meshed with it has 36 teeth. How fast\r\ndoes the second cogwheel\r\n rotate? If at some moment one tooth of the first\r\nwheel fills a gap on the second wheel, after how long will the same tooth fill the same  gap? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "192|1875", interface: "The second cogwheel rotates at [ ] rotations per minute. The same tooth will fill the same gap after [ ] miliseconds (1 second = 1000 miliseconds). ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 3, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/PROPORTIONS/proportions14.html
p = Problem.create!(filename: 'proportions14.html', curriculum: 'lifetomath', category: 'methods', context: 'proportions', text: "<p>If 6 people load 4 trucks of grains in\r\n3 hours, how long will it take for 9 people\r\nto load 5 trucks?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "150", interface: "It takes [ ] minutes to load the trucks. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 1, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/PROPORTIONS/proportions3.html
p = Problem.create!(filename: 'proportions3.html', curriculum: 'lifetomath', category: 'methods', context: 'proportions', text: "<p>\r\nSeven tractors plowed 2/5 of a lot in 18 days. After that, five more tractors joined\r\nthe eight, and together plowed the rest of the lot. How long did it take to plow the\r\nentire lot? (The work day is 8 hours.)\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "33|6", interface: "It took [ ] days and [ ] hours to plow the lot. ")
#SOLUTION TUPLE FOR PROBLEM P
s = p.solutions.create!(typ: "ruleofthree", text: "<p>\r\n\tLet us  first find out how long does\r\nit take for the \\(7+5=12\\)  tractors to plow 2/5 of the\r\nlot. Because the number of tractors is inverse proportional\r\nto the time, we set up the rule of three \r\n\\begin{alignat*}{1}\r\n18\\quad ............&\\quad \\frac{1}{7}\\\\\r\n? \\quad ............&\\quad \\frac{1}{12}.\r\n\\end{alignat*}\r\nThe number of days it takes the 12 tractors to plow\r\n2/5 of the lot is \r\n\\begin{eqnarray*}\r\n\\frac{10\\times \\frac{1}{12}}{\\frac{1}{7}}=\\frac{18\\times 7}{12}=\r\n\\frac{21}{2}\r\n\\end{eqnarray*}\r\nwhich is 10 days and a half.  \r\n</p>\r\n\r\nThe remaining 1/5 of the lot is plowed in half this time,\r\nthat is 5 days and one fourth. So the \r\nentire lot is plowed in \r\n\\begin{eqnarray*}\r\n18+10+\\frac{1}{2}+5+\\frac{1}{4}=\\color{red}{33\\frac{3}{4}}\\mbox{ days}. \r\n\\end{eqnarray*}\r\nThis is the same as <font color\"red\">33 days and 6 hours</font>.\r\n\r\n</p>\r\n")
#HINT TUPLE FOR SOLUTION S
s.hints.create!(text: "The number of tractors is inverse proportional to the time\r\nrequired to plow the lot. \r\n")
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 2, source: "")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/PROPORTIONS/proportions12.html
p = Problem.create!(filename: 'proportions12.html', curriculum: 'lifetomath', category: 'methods', context: 'proportions', text: "<p>Kate, who lives in London, was hired on Tuesday, September 30, and she started\r\nwork the next day. The contract stipulates that she works\r\nfive days a week, from Monday to Friday, and that each\r\nmonth she gets paid an amount proportional to the number\r\nof days that she worked that month. If in October she got\r\npaid 1955 pounds, how much will she get paid in November?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "1700", interface: "In November Kate will be paid [ ] pounds. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 1, source: "")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/PROPORTIONS/proportions24.html
p = Problem.create!(filename: 'proportions24.html', curriculum: 'lifetomath', category: 'methods', context: 'proportions', text: "<p>\r\nMy laptop and my wife's laptop cost altogether 1450 dollars. How much did each laptop cost if\r\n\\(\\frac{3}{7}\\) of the cost of my laptop was as much as \\(\\frac{2}{5}\\) of the cost of my wife's laptop?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/PROPORTIONS/proportions20.html
p = Problem.create!(filename: 'proportions20.html', curriculum: 'lifetomath', category: 'methods', context: 'proportions', text: "<p>The velocities of a cargo plane, a passenger plane, and a\r\nmilitary plane are proportional to the numbers \r\n\\(1; \\frac{3}{2}; 3\\). Knowing\r\nthat for the same distance the cargo plane needs eighty minutes\r\n more than the passenger plane, find the time each plane needs to travel this distance.  \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "240|160|80.", interface: "The cargo plane needs [ ] minutes, the passenger plane needs [ ] minutes, the military plane needs [ ] minutes. ")
#SOLUTION TUPLE FOR PROBLEM P
s = p.solutions.create!(typ: "ruleofthree", text: "<p>\r\nThe  distance traveled is the product of the\r\nspeed and  time, so the time is the ratio between the\r\ndistance and the speed. This means that the time is \r\nproportional to the reciprocal of the speed. So\r\n the times needed by the three planes for traveling the\r\ngiven distance are proportional to the numbers\r\n\\begin{eqnarray*}\r\n1;\\quad \\frac{2}{3};\\quad \\frac{1}{3}.\r\n\\end{eqnarray*} \r\nThis means that the time necessary for the passenger  plane to cover the distance is  \\(\\frac{2}{3}\\) of the time\r\nnecessary for the cargo plane to cover the same distance.\r\nIt follows that the 80 additional minutes that the cargo plane\r\ntravels are \\(1-\\frac{2}{3}=\\frac{1}{3}\\) of its total time.\r\nWe conclude that the cargo plane needs \\(3\\times 80=\\color{red}{240}\\) minutes\r\nto reach its destination. \r\n\r\nThe passenger plane needs 80 minutes less, that is \\(240-80=\\color{red}{160}\\) minutes. Finally, the military plane travels\r\nonly \\(\\frac{1}{3}\\) of the time that the cargo plane travels,\r\nwhich is \\(\\frac{1}{3}\\times 240=\\color{red}{80}\\) minutes.  \r\n</p>\r\n")
#HINT TUPLE FOR SOLUTION S
s.hints.create!(text: "Is the time of travel  \r\nproportional to  the velocity? \r\n")
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/PROPORTIONS/proportions2.html
p = Problem.create!(filename: 'proportions2.html', curriculum: 'lifetomath', category: 'methods', context: 'proportions', text: "<p>\r\nEight tractors plowed half of a lot in 14 days. After that, six more tractors joined\r\nthose eight, and together plowed the other half of the lot. How long did it take to plow the\r\nentire lot? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "22", interface: "It took [ ] days to plow the entire lot. ")
#SOLUTION TUPLE FOR PROBLEM P
s = p.solutions.create!(typ: "ruleofthree", text: "<p>\r\nSetting up the rule of three, we know that 8 tractors plow one half of  the lot in \r\n14 days, and we find how long will it take \\(8+6=14\\) tractors to plow the other half.  The number\r\nof days it takes to plow the lot is inverse proportional to the number of tractors, so we have\r\n\\begin{alignat*}{1}\r\n14\\quad ............&\\quad \\frac{1}{8}\\\\\r\n? \\quad ............&\\quad \\frac{1}{14},\r\n\\end{alignat*}\r\nSo the number of days it takes the 14 tractors to plow half the lot is \r\n\\begin{eqnarray*}\r\n\\frac{\\frac{1}{14}\\times 14}{\\frac{1}{8}}=\\frac{1}{\\frac{1}{8}}=8. \r\n\\end{eqnarray*}\r\nTherefore the total number of days it took to plow the entire lot is \\(14+8=\\color{red}{22}\\) days. \r\n\t</p>\r\n")
#HINT TUPLE FOR SOLUTION S
s.hints.create!(text: "If one tractor plows the lot in 10 days, two tractors plow it in\r\n5 days.\r\n")
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 3, source: "Etapa locala Mehedinti 1993, clasa a VI-a")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/PROPORTIONS/proportions6.html
p = Problem.create!(filename: 'proportions6.html', curriculum: 'lifetomath', category: 'methods', context: 'proportions', text: "<p>The number of customers of a phone company went up, since last year, by \\(\\frac{1}{4}\\). The number \r\nof minutes used by a customer went up by \\(\\frac{1}{5}\\). By how much did the total number of minutes used by the\r\ncustomers of the company grow?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: ".5", interface: "The number of minutes went up by a fraction of [ ] of the total number of minutes (express the answer as a decimal number). ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 2, source: "")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/PROPORTIONS/proportions5.html
p = Problem.create!(filename: 'proportions5.html', curriculum: 'lifetomath', category: 'methods', context: 'proportions', text: "<p>If three red balls are worth five green balls, and four\r\ngreen balls are worth five blue balls, how many red\r\nballs are 1000 blue balls worth?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "480", interface: "1000 blue balls are worth as much as [ ] red balls. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 2, source: "")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/PROPORTIONS/proportions19.html
p = Problem.create!(filename: 'proportions19.html', curriculum: 'lifetomath', category: 'methods', context: 'proportions', text: "<p>\r\nThree teams of equally qualified builders worked on an \r\napartment building. The first team, consisting of 8 people,\r\nworked for 5 days, the second team, consisting of 9 people,\r\nworked for 6 days, and the third, consisting of 12 people,\r\nworked for 7 days. How much did each team earn, if the\r\ntotal pay was 18512 dollars? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "4160|5616|8736", interface: "The first team earned [ ] dollars, the  second team earned [ ] dollars, the third team earned [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 1, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/NUMERICAL/numerical4.html
p = Problem.create!(filename: 'numerical4.html', curriculum: 'lifetomath', category: 'methods', context: 'numerical', text: "<p>\r\nBeatriz  finished reading a novel in 3 days. On the first\r\nday she read \\(\\frac{2}{3}\\) of the novel. On the second day\r\nshe read \\(\\frac{1}{5}\\) of the novel. On the third day she\r\nread the remaining 6 pages. How long is the novel? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "45", interface: "The novel is [ ] page long. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/NUMERICAL/numerical7.html
p = Problem.create!(filename: 'numerical7.html', curriculum: 'lifetomath', category: 'methods', context: 'numerical', text: "<p> A father gave to his daughter a surprise box. Inside there were 3 red boxes, each of which had 4 blue boxes inside. Inside each\r\n blue box there are 5 small red boxes, and each\r\nof these small red boxes has 6 tiny blue boxes inside. How many\r\nblue boxes, large and small, were inside the surprise box?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "372", interface: "Inside the surprise box there were [ ] blue boxes. ")
#SOLUTION TUPLE FOR PROBLEM P
s = p.solutions.create!(typ: "numerical", text: "<p> Each red box had inside 4 blue boxes, so there were altogether \\(3\\times 4=12\\) large blue boxes. Each\r\nof these large blue boxes had inside 5 small red boxes, and each of these red boxes\r\nhad inside 6 tiny blue boxes. So each large blue box had\r\ninside \\(5\\times 6=30\\) tiny blue boxes. The surprise\r\nbox thus had \\(30\\times 12=360\\) tiny blue boxes, and together with\r\nthe 12 large blue boxes it had <font color=\"red\">372</font> blue boxes. \r\n</p>\r\n")
#HINT TUPLE FOR SOLUTION S
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/NUMERICAL/numerical1.html
p = Problem.create!(filename: 'numerical1.html', curriculum: 'lifetomath', category: 'methods', context: 'numerical', text: "<p>\r\nMary, Ann, and Linda have altogether 478 cherries. After each ate the same amount of cherries,\r\nMary has 27, Ann has 35, and Linda has 47 cherries left. How many cherries did each girl have\r\nin the beginning? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "150|158|170", interface: "Mary had [ ] cherries, Ann had [ ] cherries, Linda had [ ] cherries. ")
#SOLUTION TUPLE FOR PROBLEM P
s = p.solutions.create!(typ: "numerical", text: "<p>\r\n The total amount of cherries left is\r\n\\begin{eqnarray*}\r\n27+35+47=109. \r\n\\end{eqnarray*}\r\nSo the girls have eaten \\(478-109=369\\) cherries. Each has eaten\r\n\\(\\frac{1}{3}\\) of this amount, that is \\(\\frac{369}{3}=123\\) cherries.\r\nThis means that in the beginning Mary had \\(27+123=\\color{red}{150}\\) cherries,\r\nAnn had \\(35+123=\\color{red}{158}\\) cherries, while Linda had  \\(47+123=\r\n\\color{red}{170}\\) cherries.\r\n</p>\r\n")
#HINT TUPLE FOR SOLUTION S
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 1, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/GRAPHICAL/graphical7.html
p = Problem.create!(filename: 'graphical7.html', curriculum: 'lifetomath', category: 'methods', context: 'graphical', text: "<p>\r\nThe father, mother, and daughter have deposited a total of 330 euros\r\nin the bank. The father has deposited 20 euros less than \\(\\frac{2}{3}\\) of what the mother has deposited,\r\n while the mother has deposited by \\(\\frac{1}{5}\\) less than  the daughter. How much\r\nmoney did each member of the family deposit in the bank?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "60|120|150", interface: "The father deposited [ ] dollars, the mother deposited [ ] dollars, the daughter deposited [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
s = p.solutions.create!(typ: "graphical", text: "<p>\r\nIt is not too hard to represent the amounts deposited by the mother and the daughter. We represent\r\nthe amount deposited by the daughter by five equal segments, and that of the mother by only four\r\nsuch segments:\r\n</p> \r\n<img src=\"FIGS/mofada1.gif\" alt=\"The money deposited by mother and daughter\"  width=\"400\" height=\"80\"><br>\r\n<p> \r\nBut then to represent the amount deposited by the father, we should be able to divide mother's 4 segments into\r\nthree equal parts. Thus we go back, represent the amount deposited by the daughter by 15 equal segments, that\r\nof the mother by 12 (\\(\\frac{4}{5}\\) of the amount of the daugher), and for the amount of the father\r\nwe take 8 segments (\\(\\frac{2}{3}\\) of the amount deposited by the mother) and subtract 20 dollars from that,\r\nas shown below:\r\n</p> \r\n<img src=\"FIGS/mofada2.gif\" alt=\"The money deposited by father, mother, and daughter\"  width=\"400\" height=\"140\"><br>\r\n<p> \r\nWe can put the 20 dollars back into the picture, and then we have \\(8+12+15=35\\) equal segments representing\r\na total of \\(330+20=350\\) dollars. Then one segment is worth \\(\\frac{350}{35}=10\\) dollars. Now we can compute\r\nthat the daughter deposited \\(15\\times 10=\\color{red}{150}\\) dollars, the mother deposited \\(12\\times 10=\\color{red}{120}\\) dollars,\r\nand the father deposited \\(8\\times 10-20=80-20=\\color{red}{60}\\) dollars. \r\n</p>\r\n")
#HINT TUPLE FOR SOLUTION S
s.hints.create!(text: "Use the daugther as reference.\r\n")
#HINT TUPLE FOR SOLUTION S
s.hints.create!(text: "Represent daughter's savings by 15 equal segments. \r\n")
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 1, source: "<!--Calugaru's notes-->")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/GRAPHICAL/graphical12.html
p = Problem.create!(filename: 'graphical12.html', curriculum: 'lifetomath', category: 'methods', context: 'graphical', text: "<p>Two people climb a tower at the same pace, but starting at\r\ndifferent times. At the moment when the first person arrived at half the height\r\nof the tower, this person told the second, who was 48 steps lower: &ldquo;When I will be at the top, you will\r\nbe at a height that is 8 times that at which you are now.&rdquo; How many steps does  the entire  tower have? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "112", interface: "The tower has [ ] steps. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 2, source: "Calugaru's notes.")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/GRAPHICAL/graphical2.html
p = Problem.create!(filename: 'graphical2.html', curriculum: 'lifetomath', category: 'methods', context: 'graphical', text: "<p>\r\n\r\nTogether, Rick and George have 80 dollars, George and Mike have 70 dollars, Rick and Mike\r\nhave 90 dollars. How much money does each of the boys have?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "50|30|40", interface: "Rick has [ ] dollars, George has [ ] dollars, Mike has [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 2, source: "Calugaru's notes, GM 1559, 1960/9.")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/METHODS/GRAPHICAL/graphical3.html
p = Problem.create!(filename: 'graphical3.html', curriculum: 'lifetomath', category: 'methods', context: 'graphical', text: "<p>\r\nMaria, Jenny, and Laura have 135 dollars. Maria and Jenny have\r\n95 dollars, and Maria and Laura have 75 dollars. How much money\r\ndoes each of the girls have? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "35|60|40", interface: "Maria has [ ] dollars, Jenny has [ ] dollars, and Laura has [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#HINT TUPLE FOR SOLUTION S
s.hints.create!(text: "Represent the area cultivated with tomatoes by 3 boxes. \r\n")
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "methods", context: "methods", diff: 1, source: "Calugaru")
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "0", interface: "Enter 1 for yes, 0 for no. The answer is [ ]. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "1", interface: "Enter 1 for yes, 0 for no. The answer is [ ]. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "10", interface: "The tub fills in [ ] hours. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "2|13|20", interface: "With both faucetts open, the tub will fill in [ ] hours [ ] minutes and [ ] seconds. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "1", interface: "Enter 1 for yes, 0 for no: [ ]. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "180", interface: "With both faucets and the drain open, it takes [ ] minutes to fill the tub. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "42|30|10", interface: "The first cask holds [ ] gallons, the second cask holds [ ] gallons, the third cask holds [ ] gallons. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "1|3", interface: "The number of faucets that  flow at 250 liters per hour is [ ] and the number of faucets that flow at 270 liters per hour is [ ]. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "3975", interface: "If we leave the faucets open for 8 hours, [ ] gallons flow into the tank. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "2|40", interface: "With all three faucets open, the tub fills in  [ ] hours and [ ] minutes. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "48", interface: "At the beginning of the season there were [ ] gallons in the barrel. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "12|24", interface: "This first faucet fills the tub in [ ] hours, the second faucet fills the tub in [ ]  hours. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "15", interface: "One jug of grape juice is enough for [ ] bottles. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "200|300|150", interface: "In one hour through the first faucet flow [ ] gallons, through the second [ ] gallons, and throught the third [ ] gallons. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "2", interface: "The farmer should add [ ] apples. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "24|12|15", interface: "There are [ ] red balls, [ ] blue balls, and [ ] green balls. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "24000", interface: "The total quantity was [ ] gallons of gas. ")
#SOLUTION TUPLE FOR PROBLEM P
...
p = Problem.create!(filename: 'quantity22.html', curriculum: 'lifetomath', category: 'applications', context: 'quantities', text: "<p> Three boys have collected a total of 420 cards. If the first one gave the second four cards, and the third had three times as many\r\nas he has, then each would have the same number or cards. How many cards\r\ndoes each of the boys have?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "184|176|60", interface: "The first boy has collected [ ] cards, the second boy has collected [ ] cards, and the third boy has collected [ ] cards. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "30|10|15", interface: "Mary has posted [ ] video clips, Jane has posted [ ] video clips, Ann has posted [ ] video clips. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "225|675", interface: "During the first week, the farmer sowed [ ] acres of soybeans and [ ] acres of wheat. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "27", interface: "You can dye at most [ ] eggs. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "233", interface: "Eugenio picked [ ] oranges. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "562.5", interface: "The largest amount of chocolate roll that you can make is [ ] grams. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "2400|400", interface: "The length of the road is [ ] meters, and [ ] meters of road were paved on the fifth day. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "11", interface: "You need [ ] eggs. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "16", interface: "We should draw [ ] balls. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "96", interface: "[ ] students went on the field trip. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "5", interface: "There are [ ] people at the table. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "79", interface: "The maximal play time is [ ] minutes. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "24", interface: "[ ] students went to swim in the river. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "530", interface: "Five sacks of wheat and five sacks of maize weigh [ ] kilograms. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "45", interface: "There are [ ] students. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "8", interface: "Ram got [ ] mangoes. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "128", interface: "Maria ends up with [ ] apples. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "31|44|19", interface: "There are [ ] red balls, [ ] blue balls, and [ ] green balls. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "7|6|3", interface: "Clara had [ ], Beatriz had [ ], and Davi had [ ] oranges in their left hands. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "4", interface: "The smallest number of students who play all three sports is [ ]. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "41|80", interface: "There are [ ] cherries and [ ] strawberries in the basket. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "100", interface: "The empty box weighs [ ] grams. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "113.75", interface: "The speed of the car must be [ ] kilometers per hour. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "7.25|2|25.", interface: "They met at [ ] kilometers from the start, at [ ]:[ ] pm. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "15", interface: "It takes Jack [ ] minutes to go to school. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "422.4", interface: "The length of the train is [ ] feet. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "3300", interface: "The bridge is [ ] meters long. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "52.5", interface: "The speed of the truck is [ ] miles per hour. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "56.25", interface: "The slower car must increase its speed by [ ] km/h. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "5400", interface: "The distance between the cities is [ ] miles. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "2", interface: "The snail traveled  [ ] feet. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "75", interface: "The real speed of the car is [ ] miles per hour. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "4|96000", interface: "The second rocket would overpass the first after [ ] hours, at which moment the distance to the moon is [ ] kilometers. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "11.25", interface: "The total distance traveled by the fly is [ ] miles. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "4.95", interface: "The velocity of the floating boat would be [ ] km/h. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "13.5", interface: "The distance between the two towns is [ ] kilometers. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "9", interface: "The distance between the camp and the town is [ ] miles. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "76.8", interface: "The velocity of the second car is [ ] km/h. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "6", interface: "The passenger plane will be at half distance between the cargo plane and Newton City after [ ] hours. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "5", interface: "The Blue met the Green at [ ] o'clock. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "2|4", interface: "The shortest distance the snail could have traveled is [ ] feet. The longest distance the snail could have traveled is [ ] feet. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "6|10", interface: "The shortest time is [ ] hours and [ ] minutes. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "70", interface: "The cargo trains is traveling at [ ] kilometers per hour. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "5", interface: "The boat is [ ] times faster than the river. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "13", interface: "The snail climbed the well in [ ] days. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "8", interface: "He used [ ] gallons of gas. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "24", interface: "The distance between the two towns is [ ] kilometers. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "15660", interface: "The bike traveled  [ ] feet. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "48|45", interface: "The boat travels downstream [ ] minutes and [ ] seconds. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "5|15", interface: "The slower boat will travel the same distance i [ ] hours and [ ] minutes. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "1|40", interface: "The kayak from upstream should start [ ] hours and [ ] minutes later. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "2|13|20", interface: "The shortest time needed is [ ] hours, [ ] minutes, and [ ] seconds. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "420", interface: "Pierre traveled a total of [ ] kilometers. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "52", interface: "The raft would take [ ] hours to travel this distance. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "5|30", interface: "It will take George [ ] hours and [ ] minutes to travel from his farm to \(B\). ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "71.63", interface: "You should be driving at [ ] kilometers per hour. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "1152", interface: "The tax paid for the product is [ ] lei. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "5", interface: "Rinaldo should use [ ] lemons. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "1", interface: "The solution that Ann made has concentration [ ]%. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "2700", interface: "By selling all the fruit, the farmer earned [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "75", interface: "On the tour there are [ ] American tourists. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "1|1", interface: "Enter 1 for less, 2 for more. The sallary is by [ ]%  [ ] than initially. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "9.33", interface: "The fruit juice concentration in the resulting drink is [ ] %. (Truncate to two digits.) ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "45", interface: "[ ] % of the students solved both problems correctly. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "1350|55", interface: "He should sell his computers for [ ] dollars and [ ] cents. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "21", interface: "The distance increases by [ ] %. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "50", interface: "The original price of the shirt was [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "20", interface: "The first drink should be [ ] % of the resulting drink. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "3400|1200", interface: "I have [ ] cherries, you have [ ] cherries. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "32", interface: "The percentage of those who voted for A in the second round from those who voted for C in the first round is [ ] %. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "10", interface: "The new concentration will be [ ] %. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "2", interface: "Enter 1 for apples and 2 for pears. The farmer sold more  [ ]. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "12.36", interface: "The resulting concentration will be [ ] %. (Truncate to two digits.) ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "37.5", interface: "The amount of cherries that you can buy decreased by  [ ] %. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "37.5", interface: "The percentage of apple juice is [ ] %. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "168000", interface: "Two years ago the city had [ ] inhabitants. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "500", interface: "[ ] students. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "12", interface: "Rinaldo should use [ ] lemons. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "660|920|1200", interface: "The first agent sold [ ] devices, the second agent sold [ ] devices, the third agent sold [ ] devices. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "2|51.46", interface: "Enter 1 for A, 2 for B. Candidate [ ] won with [ ] % of the votes.  (Truncate to two decimals.) ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "3", interface: "She made [ ] of her last 5 shots. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "2.5", interface: "Whole milk has [ ] percent fat. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "10125", interface: "[ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "6", interface: "Rinaldo should use [ ] apples. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "184|33", interface: "The highest price you can afford is [ ] dollars and [ ] cents. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "87", interface: "The average score was [ ] points. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "0", interface: "Mary's total minus Mike's total is [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "30", interface: "In that class there are [ ] students. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "25", interface: "[ ]% of the students who play basketball are girls. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "28", interface: "The number of students who are members of science clubs  is [ ]. ")
#SOLUTION TUPLE FOR PROBLEM P
...
p = Problem.create!(filename: 'money13.html', curriculum: 'lifetomath', category: 'applications', context: 'money', text: "<p>The currency of Romania has coins worth 50 bani, 10 bani, and 5 bani. In how many ways can one pay with coins the amount of 95 bani?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "15", interface: "The sum can be paid in [ ] ways. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "6", interface: "The construction worker worked [ ] days. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "4|1", interface: "The traveler with 3 loaves gets [ ] dollars, the traveler with 2 loaves gets [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "1|1", interface: "Enter 1 for yes, 0 for no. The answer to the first question is [ ]. The answer to the second ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "972", interface: "After the first reduction the price was [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "15|22", interface: "There were [ ] carpenters and [ ] roofers. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "60", interface: "One apple costs [ ] cents. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "730", interface: "There are [ ] ways in which the amount can be paid. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "6", interface: "The bank should pay [ ] different values of bills. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "0", interface: "")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "498", interface: "Annie can withdraw at most [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "36", interface: "He has left [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "17", interface: "4 daffodils and 3 tulips cost [ ]. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "5|6", interface: "Yang sold [ ] T-shirts and [ ] cups. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "18|12", interface: "Patricia bought [ ] red pens and [ ] green pens. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "1.5", interface: "One loaf of bread is worth [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "24000|60000|45000", interface: "Attila earned [ ] forint on the first day, [ ] forint on the second day, and [ ] on the third day. ")
#SOLUTION TUPLE FOR PROBLEM P
...
p = Problem.create!(filename: 'money4.html', curriculum: 'lifetomath', category: 'applications', context: 'money', text: "<p>If the price of a pineapple increased by fifty cents, then three pineapples would be worth the same  as seven\r\nmangoes. If the price of a pineapple decreased by fifty cents,\r\nthen three pineapples would be worth the same  as two mangoes. What is the price of a pineapple?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "90", interface: "The price of a pineapple is [ ] cents. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "1140", interface: "During the third month, Paul earned [ ] euros. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "3", interface: "The smallest number of coins is [ ]. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "45", interface: "She has left [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
p = Problem.create!(filename: 'money6.html', curriculum: 'lifetomath', category: 'applications', context: 'money', text: "<p>Three carpenters working together received for a project 1575 dollars. The share of the first\r\ncarpenter was twice as much as what those of the second and the third combined. The second\r\ncarpenter earned with 15 dollars more than the third. How much did each carpenter earn?   \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "1050|270|255", interface: "The first carpenter earned [ ] dollars, the second carpenter earned [ ] dollars, the third carpenter earned [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "1|3", interface: "All bills giving the remainder [ ] when divided by [ ]. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "19", interface: "Ann is [ ] years old. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "4", interface: "I will get the chance to buy McIntosh apples [ ] times. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "40|20|10", interface: "The father is [ ] years old, the older son is [ ] years old, and the younger son is [ ] years old. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "2|12.", interface: "Enter the <b>sum</b> of the dates in March here [ ] and the <b>sum</b> of the dates in April here [ ]. (If there are no dates in March or April, enter 0, if there is only one date, enter that date. For example if the dates are March 5th, April 9th, April 12th enter 5, then 21.) ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "36", interface: "Robert is [ ] years old. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "12|38", interface: "The daughter is [ ] years old, while each of the parents is [ ] years old. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "6", interface: "Assign to each of the dates the following labels: February 1 \(\mapsto\) 1, 	February 2 \(\mapsto\) 2, 	February 3 \(\mapsto\) 3, March 4 \(\mapsto\) 4, 	March 5 \(\mapsto\) 5, April 2 \(\mapsto\) 6, 	April 6 \(\mapsto\) 7, May 1 \(\mapsto\) 8, 	May 4 \(\mapsto\) 9,	May 6 \(\mapsto\) 10. Enter [ ] the label of the date that is the answer to the problem. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "26", interface: "Today Jos&eacute; is [ ] years old. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "12|0", interface: "The buses will leave again after [ ] hours and [ ] minutes. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "2", interface: "The ships leave on the same day [ ] times a year. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "13", interface: "The boy is [ ] years old. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "4", interface: "That year, the ships will spend a full day together at the harbor [ ] times. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "6", interface: "The treaty was signed on day [ ] of the week.  ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "37", interface: "Professor Garibaldi should start walking after [ ] hours from the moment he saw the volcanoes starting to erupt. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "1967", interface: "Michael was born in year [ ]. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "7", interface: "Number the days of the week starting with Sunday=1. The treaty was signed on day [ ] of the week. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "37", interface: "Today Celine is [ ] years old. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "3", interface: "The age of the daughter is [ ] years. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#HINT TUPLE FOR SOLUTION S
s.hints.create!(text: "The mother is always 24 years older than the daughter. \r\n")
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "applications", context: "time", diff: 1, source: "source")
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "12", interface: "The mother will be twice as old as the daughter in [ ] years. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "9|6|1", interface: "The oldest child is [ ] years old, the second oldest is [ ] years old, while the youngest is [ ] years old. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "10", interface: "The ships spend together a full day [ ] times a year. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "28|22|36", interface: "Bob is [ ] years old, Jim is [ ] years old, and Sam is [ ] years old. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "20", interface: "The average age of the people is [ ] years. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "20.4", interface: "The average temperature is [ ] &#x2103;. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "24", interface: "Gabriela's age is [ ] years. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "6", interface: "The age of their son is [ ] years. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "24", interface: "The average age of the remaining people is [ ] years. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "162.5", interface: "The average height of the students at that school is [ ] centimeters. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "31|16|14.5", interface: "The water in the first bucket has [ ] &#x2103;, the water in the second bucket has [ ] &#x2103; and the water in the third bucket has [ ] &#x2103;. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "51", interface: "The two liters are at [ ] &#8457;. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "11", interface: "Before the new member joined it, the club had [ ] members. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "160", interface: "The tank has [ ] liters. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "2|48", interface: "The total duration of the trip was [ ] hours and [ ] minutes. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "37.92", interface: "The average age is [ ] years. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "35", interface: "The average age of the remaining people is [ ] years. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/ONEVAR/onevar7.html
p = Problem.create!(filename: 'onevar7.html', curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', text: "<p>\r\nRoberto's boss asked him to make a 10% solution by\r\nmixing 1 liter of fructose syrup with 10 liters of water. \r\nRoberto realized that his boss was mistaken and that the\r\nresulting solution has the wrong concentration. Which of\r\nthe fructose syrup or water should he add, and in what amount,\r\nin order to obtain a 10% solution? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "2|1.11", interface: "Enter 1 for water and 2 for fructose. Roberto has to add [ ], in the amount of [ ] liters. (Truncate to two decimals.) ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 1, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/ONEVAR/onevar22.html
p = Problem.create!(filename: 'onevar22.html', curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', text: "<p>\r\nIn a class ther are both boys and girls. The girls are \r\n\\(\\frac{3}{7}\\) of the total number of students. If 4 more girls\r\njoin the class, then the girls are \\(\\frac{1}{2}\\) of the\r\nstudents. How many students were in that class before the 4 girls\r\njoined?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "28", interface: "In that class were [ ] students before the 4 girls joined. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 1, source: "Gheba")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/ONEVAR/onevar20.html
p = Problem.create!(filename: 'onevar20.html', curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', text: "<p>\r\nSunita bought mangoes, of which she gave \\(\\frac{1}{4}\\) to her brother Ram,\r\n and she ate 6 mangoes. Of the remaining mangoes, Sunita gave \\(\\frac{3}{7}\\) to her neighbor,\r\n and she kept  the rest of 24 mangoes for herself. How many mangoes did Ram get? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "16", interface: "Ram got [ ] mangoes. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/ONEVAR/onevar1.html
p = Problem.create!(filename: 'onevar1.html', curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', text: "<p>\r\nAlice sells a product at 10 dollars less than the listed price and she recieved a bonus of\r\n10% of her price. Bob sold the same product at 20 dollars less than the listed price and\r\nhe recieved a bonus of 20% of his price. Knowing that both recieved the same bonus, find the \r\nlisted price.\r\n </p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "30", interface: "The listed price is [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 1, source: "1983 AHSME")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/ONEVAR/onevar26.html
p = Problem.create!(filename: 'onevar26.html', curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', text: "<p> You have 5 liters of water at  58 &#8457;. How much\r\nwater at a temperature of 40  &#8457; should you add so\r\nthat the resulting mix will have a temperature of 50  &#8457;?  \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "4", interface: "You should add [ ] liters. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 1, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/ONEVAR/onevar23.html
p = Problem.create!(filename: 'onevar23.html', curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', text: "<p> What time is it if what is left of the day is \\(\\frac{5}{3}\\) of what has already passed? (The day has 24 hours and it starts\r\nat midnight. The hours should be counted from 1 to 24).\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "9", interface: "It is [ ] o'clock. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/ONEVAR/onevar17.html
p = Problem.create!(filename: 'onevar17.html', curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', text: "<p>\r\nAn alloy is 65% gold and weighs 2.5 ounces. How much gold should we\r\nadd to obtain an alloy that that is  95% gold?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "15", interface: "We should add [ ] ounces of gold. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 2, source: "Gheba, modified")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/ONEVAR/onevar19.html
p = Problem.create!(filename: 'onevar19.html', curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', text: "<p>\r\nI have some blue balls. I exchange half of them with\r\nred balls, five red balls for each blue ball. Then\r\nI exchange two thirds of the red balls with green balls,\r\nfive green balls for each red ball. I now have 754 balls.\r\nHow many of them are red? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "65", interface: "Of the 754 balls that I have in the end, [ ] are red. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/ONEVAR/onevar3.html
p = Problem.create!(filename: 'onevar3.html', curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', text: "<p>Two trains start at the same time, one from Paris\r\nand one from London, traveling towards each other. The first\r\ntrain travels at 150 mph while the second travels at 180 mph.\r\nAt what distance from Paris do they meet, knowing that the distance\r\nfrom Paris to London is 880 miles? \r\n\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "400", interface: "The trains met [ ] miles from Paris. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 6, source: "Moscow Math Olympiad, 1998, Level B")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/ONEVAR/onevar4.html
p = Problem.create!(filename: 'onevar4.html', curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', text: "<p>\r\nMary leaves work at 1 pm and decides to bike to her home,\r\nwhich is 16 miles away. After a while she decides the\r\nget off her bike and walk the rest of the way. How\r\nfar from home did she get off the bike if her biking\r\nspeed is 10 mph, her walking speed is 2 mph, and she arrived\r\nat home at 3 pm?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "1", interface: "She got off the bike [ ] miles from home. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/ONEVAR/onevar25.html
p = Problem.create!(filename: 'onevar25.html', curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', text: "<p>  \r\nTo study a math book you are supposed to solve 20 problems per\r\nday. But you are clever and you go at a pace of 75 problems every\r\n3 days. Three days before the deadline you are 5 problems short from\r\nfinishing the book. How many problems are in the math book?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "280", interface: "The book has [ ] problems. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/ONEVAR/onevar10.html
p = Problem.create!(filename: 'onevar10.html', curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', text: "<p>\r\nA city has today 176505 inhabitants. \r\nKnowing that the population of that city increased annually\r\nby 2.5% find what the population was 2 years ago. \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "168000", interface: "Two years ago the city had [ ] people. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 1, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/ONEVAR/onevar24.html
p = Problem.create!(filename: 'onevar24.html', curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', text: "<p>  Six brothers divided an inheritance as follows:\r\nthe first took half of the inheritance plus 500 dollars, the\r\nsecond took half of what was left plus 500 dollars, and they\r\ncontinued the same way, and when the last brother took his\r\nshare, the inheritance was completely divided. What was\r\nthe value of the inheritance?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "63000", interface: "The value of the inheritance was [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 3, source: "Gheba, slightly modified")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/ONEVAR/onevar9.html
p = Problem.create!(filename: 'onevar9.html', curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', text: "<p>\r\nA passenger plane and a cargo plane fly between the same\r\ntwo cities and they leave at the same time. The passenger\r\nplane travels at 720 mph and arrives 3 hours before the\r\nthe cargo plane, which travels at 540 mph. Find\r\nthe distance between the cities.  \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "6480", interface: "The distance between the cities is [ ] miles. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/ONEVAR/onevar14.html
p = Problem.create!(filename: 'onevar14.html', curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', text: "<p>\r\nFrom a total quantity of gasoline a gas station sold the first day \\(\\frac{5}{7}\\) of the total quantity plus 900 gallons,\r\nthe second day \\(\\frac{1}{14}\\) of the total quantity plus 600 gallons, and the third day the rest, which was \\(0.1\\) of\r\nthe total quantity plus another 1000 gallons. What was the total\r\nquantity of gasoline sold during the three days? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "21875", interface: "The total quantity was [ ] gallons of gas. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 1, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/ONEVAR/onevar5.html
p = Problem.create!(filename: 'onevar5.html', curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', text: "<p>\r\nTwo bikers traveled the same distance. The first, who\r\nis by 2 mph slower than the second had to bike 45 minutes longer.\r\nFind the speed of each biker, knowing that the second biked for \r\n3 hours.\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "8|10", interface: "The speed of the slower biker is [ ] miles per hour, the speed of the faster biker is [ ] miles per hour. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 1, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/ONEVAR/onevar6.html
p = Problem.create!(filename: 'onevar6.html', curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', text: "<p>\r\nA group of hikers leaves town at noon, at the same time with\r\na horse rider,  to go to a forest 10 kilometers away. \r\n While the hikers walk at 3 km/h, the horse rider travels at 9 km/h.\r\nThe rider arrives in the forest, rests for an hour, then returns to meet the\r\nhikers. How far from the city and at what time does the rider meet the hikers?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "7.25|2|25.", interface: "They met [ ] kilometers from the start. They met at [ ]:[ ] pm. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 3, source: "Gheba")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/ONEVAR/onevar11.html
p = Problem.create!(filename: 'onevar11.html', curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', text: "<p>\r\nI have borrowed 39720 dollars at an interest of 10%. The\r\ninterest is computed at the end of each month, by adding \r\nto the amount that I still owe 10% of the value of that\r\namount. I am supposed to pay this money back in three equal\r\npayments, one after exactly one month, one after two months,\r\nand one after 3 months from the moment when I borrowed the money.\r\nWhat should these payments  be? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "15972", interface: "At the end of each month I should pay [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 5, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/ONEVAR/onevar12.html
p = Problem.create!(filename: 'onevar12.html', curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', text: "<p>\r\nIf the students in one class sat 2 at a desk, 5 more desks would\r\nbe needed. If they sat 3 at a desk, 3 desks would be\r\nleft unoccupied. How many students are in the class?\r\n </p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "48", interface: "There are [ ] students in that class. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 1, source: "locala Alba, a V-a, 1994")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/ONEVAR/onevar13.html
p = Problem.create!(filename: 'onevar13.html', curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', text: "<p>\r\nFive brothers split their inheritance as follows: the first brother took \\(\\frac{1}{5}\\) of the sum, the second\r\n\\(\\frac{1}{5}\\) of what remained plus 400 dollars, the\r\nthird \\(\\frac{1}{5}\\) of what remained plus 800 dollars, \r\nthe fourth \\(\\frac{1}{5}\\) of what remained plus 1200 dollars, \r\nand the fifth \\(\\frac{1}{5}\\) of what remained plus 1600 dollars.\r\nNow the inheritance was completely distributed. What was\r\nthe value of the inheritance?\r\n </p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "1718.75", interface: "The value of the inheritance is [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 6, source: "judeteana Botosani, a V-a, 1994, modified")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/ONEVAR/onevar16.html
p = Problem.create!(filename: 'onevar16.html', curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', text: "<p>\r\nI rented a kayak for 3 hours to paddle on a river\r\nthat flows at 1.5 miles per hour. How far can I go upstream\r\nso that if I paddle at constant speed 4.5 miles per hour I \r\nwill return at the required time?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "6", interface: "I traveled [ ] miles upstream. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 1, source: "Gheba, modified")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/ONEVAR/onevar8.html
p = Problem.create!(filename: 'onevar8.html', curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', text: "<p>\r\nIf you mix a  drink with a fruit juice concentration \r\nof 14% with another  drink with a fruit juice concentration\r\nof 9%, in what percentage should the first drink be to \r\n the total amount so that the resulting drink has a fruit juice concentration of 10%?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "20", interface: "The first drink should be [ ]% of the total amount of drink. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "onevar", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/CANCEL/cancel15.html
p = Problem.create!(filename: 'cancel15.html', curriculum: 'lifetomath', category: 'algebraic', context: 'cancel', text: "<p> A juice manufacturer buys fruits every month. Between one\r\nmonth and the next, the price of fruits goes up by 20% and the\r\namount of money the manufacturer has for buying fruits goes up by 17%. The amount of fruits that the manufacturer can buy \r\ndecreases by what percentage?  \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "2.5", interface: "The amount of fruits that the manufacturer can buy decreases by [ ] percent. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "cancel", diff: 3, source: "Dropped AHSME, modified")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/CANCEL/cancel3.html
p = Problem.create!(filename: 'cancel3.html', curriculum: 'lifetomath', category: 'algebraic', context: 'cancel', text: "<p>\r\nHow long does it take a car to travel between two cities at constant speed, knowing that if during the second\r\nhalf of the road it decreased its speed by 20% it would arrive an hour late? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "4|0", interface: "It takes [ ] hours and [ ] minutes. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "cancel", diff: 3, source: "Ghergu, 79/13 modified")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/CANCEL/cancel4.html
p = Problem.create!(filename: 'cancel4.html', curriculum: 'lifetomath', category: 'algebraic', context: 'cancel', text: "<p>\r\nIn a store, as the result of a 20% decrease in the  price of a product the earnings increased by 8%. \r\nBy what percent did the number of sold products grow? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "35", interface: "The number of sold products increased by  [ ]%. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "cancel", diff: 3, source: "Ghergu, 82/13")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/CANCEL/cancel7.html
p = Problem.create!(filename: 'cancel7.html', curriculum: 'lifetomath', category: 'algebraic', context: 'cancel', text: "<p>\r\nIf I decrease the price of apples  by 20%, by what\r\npercentage should I increase the amount of apples sold so\r\nthat my gains are the same?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "25", interface: "The amount of apples sold should increase by [ ] percent. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "cancel", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/CANCEL/cancel6.html
p = Problem.create!(filename: 'cancel6.html', curriculum: 'lifetomath', category: 'algebraic', context: 'cancel', text: "<p>\r\nIf I increase the speed by 25% and I decrease the distance by 15%, does the time of travel increase,\r\ndecrease, or stay the same? By what percent? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "3|32", interface: "Enter 1 for increase, 2 for stay the same, 3 for decrease. My time of  travel will [ ] by [ ] %. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "cancel", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/CANCEL/cancel8.html
p = Problem.create!(filename: 'cancel8.html', curriculum: 'lifetomath', category: 'algebraic', context: 'cancel', text: "<p>\r\nA ship travels at a constant velocity with respect to the\r\nwater. On the first day the ship travels downstream from \r\nAllen Harbor to Benton. On the second day it travels upstream from\r\nBenton to Allen Harbor. After passing the entire travel time\r\nof the previous day, the ship is only \\(\\frac{3}{5}\\) into the trip. How \r\nmany times greater is the velocitiy of the\r\nboat as compared to the one of the water?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "4", interface: "The ship is [ ] times faster than the river. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "cancel", diff: 1, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/CANCEL/cancel16.html
p = Problem.create!(filename: 'cancel16.html', curriculum: 'lifetomath', category: 'algebraic', context: 'cancel', text: "<p>\r\nIf I increase the speed by 25% and I decrease  the time by 25%, does the distance that I  travel increase,\r\ndecrease, or stay the same? By what percent? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "3|2.65", interface: "Enter 1 for increase, 2 for stay the same, 3 for decrease. My traveling distance will [ ] by [ ] %. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "cancel", diff: 1, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/CANCEL/cancel12.html
p = Problem.create!(filename: 'cancel12.html', curriculum: 'lifetomath', category: 'algebraic', context: 'cancel', text: "<p> \r\nA reservoir has enough drinking water to last 40 days. \r\nBy what percentage should the daily consumption be \r\nreduced so that the water lasts 50 days? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "20", interface: "The percentage is [ ]%. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "cancel", diff: 3, source: "Judeteana Maramures, a VI-a, 1994,")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/CANCEL/cancel13.html
p = Problem.create!(filename: 'cancel13.html', curriculum: 'lifetomath', category: 'algebraic', context: 'cancel', text: "<p> \r\nA kayaker paddling  upstream on the Allegheny River in Pittsburgh\r\nlost a plastic bottle when going under the 31st Street Bridge.\r\nThe kayaker continued going upstream and after 30 minutes noticed\r\nthe missing bottle, then returned and caught up with the missing\r\nbottle under the Fort Duquesne Bridge. How fast was the Allegeny River flowing if the distance between the two bridges is 2 miles?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "2", interface: "The velocity of the Allegheny River is [ ] miles per hour. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "cancel", diff: 6, source: "Gheba, modified")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/CANCEL/cancel10.html
p = Problem.create!(filename: 'cancel10.html', curriculum: 'lifetomath', category: 'algebraic', context: 'cancel', text: "<p>\r\nA mother has split a basket of berries amount her three children. The number of berries that the children received\r\nare proportional to the numbers 2,3,4. The first child got\r\nby 9 berries less than the third  child would have got\r\nhad the number of berries given to each been proportional with\r\nthe numbers \\(\\frac{1}{2},\\frac{1}{3},\\frac{1}{4}\\). How\r\nmany berries were in the basket? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "1053", interface: "There were [ ] berries in the basket. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "cancel", diff: 4, source: "locala Buzau, a VI-a, 1994, Marin Grigori")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/CANCEL/cancel11.html
p = Problem.create!(filename: 'cancel11.html', curriculum: 'lifetomath', category: 'algebraic', context: 'cancel', text: "<p> A store increased the price of a product by \\(p\\)%, then\r\ndecreased it by \\(p\\)%, then increased it by \\(p\\)% and arrived\r\nat 1152 dollars.\r\n Had it first decrease it by \\(p\\)%, then increase it by \r\n\\(p\\)%, and then decrease it  \r\nby \\(p\\)%, it would have arrived at 768 dollars. What is \\(p\\)?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "20", interface: "The percentage is [ ]%. ")
#SOLUTION TUPLE FOR PROBLEM P
...
s.hints.create!(text: "Cancel \\(x\\) using the two equations. \r\n")
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "cancel", diff: 5, source: "Judeteana Buzau, a VII-a, 1994, Apostol Constantin")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/CANCEL/cancel17.html
p = Problem.create!(filename: 'cancel17.html', curriculum: 'lifetomath', category: 'algebraic', context: 'cancel', text: "<p>\r\nI usually travel from home\r\n to work at the same constant speed and arrive\r\non time. Today I left at the same time\r\nand increased my speed by 10 mph, and\r\nI arrived 15 minutes early. But yesterday, I left 6 minutes early and decreased my speed\r\nby 10 mph, and I arrived 15 minutes late. What is the\r\ndistance from my house to work?  \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "105", interface: "The distance from my house to work is [ ] miles. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "cancel", diff: 3, source: "AA Magazine, modified")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/CANCEL/cancel2.html
p = Problem.create!(filename: 'cancel2.html', curriculum: 'lifetomath', category: 'algebraic', context: 'cancel', text: "<p>\r\n65% of the total number of students in a classroom have solved the homework correctly. \r\nKnowing that 14 boys and 35% of the girls had mistakes on the homework, find out how\r\nmany boys are in the classroom. \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "40", interface: "There are [ ] boys in the classroom. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "cancel", diff: 3, source: "Ghergu, 77/13 modified")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/CANCEL/cancel5.html
p = Problem.create!(filename: 'cancel5.html', curriculum: 'lifetomath', category: 'algebraic', context: 'cancel', text: "<p>\r\nIf I increase my speed by 10% and I decrease my time of travel by 10% will the distance\r\nthat I travel increase, decrease, or stay the same? By what percent? (Enter 0% if the distance\r\nstays the same.)\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "3|1", interface: "Enter 1 for increase, 2 for stay the same, 3 for decrease. The distance I travel will [ ] by [ ] %. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "cancel", diff: 1, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/CANCEL/cancel9.html
p = Problem.create!(filename: 'cancel9.html', curriculum: 'lifetomath', category: 'algebraic', context: 'cancel', text: "<p>\r\nThe monthly scholarship that a student  receives is by\r\nthe same amount less than 450 dollars that it would be \r\nover 450 dollars if the value of the \r\nscholarship were  doubled. What\r\nis the amount of money that the student receives every month?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "300", interface: "The student receives [ ] every month. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "morevar", diff: 3, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/MOREVAR/morevar8.html
p = Problem.create!(filename: 'morevar8.html', curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', text: "<p>\r\nAt a school, in the sixth, seventh, and eighth grade there\r\nare altogether 370 students. 30% of the sixth graders went on\r\na trip. The number of sixth graders who went on the trip is\r\n20% of the total number of seventh graders at that school\r\nand 25% of the eight graders? How many sixth, seventh, and eight graders are at that school? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "100|150|120", interface: "At the school there are [ ] sixth graders, [ ] seventh graders, and [ ] eighth graders. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "morevar", diff: 3, source: "judeteana Prahova, a VI-a, 1993.")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/MOREVAR/morevar3.html
p = Problem.create!(filename: 'morevar3.html', curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', text: "<p>\r\nBoth me and you have several balls. If I give you three\r\nand lose two of my balls, and if you also buy a ball, then I\r\nhave twice as many as you have. However, if you give me five and lose one of balls, then I have three times as many balls as\r\nyou have. How many balls do we have together?  \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "121", interface: "Together we have [ ] balls. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "morevar", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/MOREVAR/morevar7.html
p = Problem.create!(filename: 'morevar7.html', curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', text: "<p>Mike drove for four hours, first on a dirt road at 40 miles per hour and then on a paved road at 60 miles per hour. His car\r\nmade 20 miles per gallon on the dirt road and 30 miles per gallon on the paved road. \r\nKnowing that he traveled a total of 210 miles, find out how much gas he has used. \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "8", interface: "Mike used [ ] gallons. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "morevar", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/MOREVAR/morevar9.html
p = Problem.create!(filename: 'morevar9.html', curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', text: "<p>\r\nThe velocity of the river Danube in Budapest is 3km/h. \r\nA tourist boat whose relative velocity with respect to \r\nwater is 18km/h travels first downstream and then upstream,\r\nreturning to the starting point after three hours. How\r\nlong does the boat travel downstream?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "75|0", interface: "The boat travels downstream [ ] minutes and [ ] seconds. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "morevar", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/MOREVAR/morevar4.html
p = Problem.create!(filename: 'morevar4.html', curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', text: "<p>\r\nA teacher returns a graded test to her class. The\r\naverage score for the students who passed was 60. The\r\naverage score for the students who failed was 35. The\r\naverage score for the class was 40. What percentage\r\nof the students have passed the exam?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "20", interface: "[ ] % of the students passed the exam. ")
#SOLUTION TUPLE FOR PROBLEM P
...
s.hints.create!(text: "This is the hint.\r\n")
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "morevar", diff: 6, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/MOREVAR/morevar16.html
p = Problem.create!(filename: 'morevar16.html', curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', text: "<p>\r\nI have sold at the cattle market a herd made out of bred heifers\r\nand open heifers. I sold the bred heifers at $2000 a piece, and\r\nopen heifers at $1500 a piece. I sold a total of 50 animals,\r\nand made  85000 dollars. How many bred heifers and how many\r\nopen heifers did I sell?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "20|30", interface: "I sold [ ] bred heifers and [ ] open heifers. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "morevar", diff: 1, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/MOREVAR/morevar20.html
p = Problem.create!(filename: 'morevar20.html', curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', text: "<p>\r\nTwo race cars start at the same point of a 4.59 mile circuit\r\nand travel with constant speeds in\r\nopposite directions.  They  meet the first time after 81  seconds, and they meet the third time at the starting point.\r\n What are the velocities\r\nof the cars, in miles per hour?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "136|68", interface: "The faster car travels at [ ] mph and the slower car travels at [ ] mph. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "morevar", diff: 3, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/MOREVAR/morevar25.html
p = Problem.create!(filename: 'morevar25.html', curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', text: "<p> Two buckets of water at different temperatures are\r\nplaced in a room. Jimmy enters the room, takes \r\n3 glasses of water from the first bucket and 5 glasses of\r\nwater from the second, mixes them in a jug, and measures\r\nthe temperature of the water from the jug to be 19 \r\n&#x2103;. He then takes 2 glasses of water from the first\r\nbucket and 6 glasses of water from the third bucket, mixes\r\nthem in another jug, and measures the temperature of the water\r\nin the jug to be 22  &#x2103;. What\r\nis the temperature of the water in each bucket?  \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "4|28", interface: "The temperature of  water in the first bucket is [ ] &#x2103; and the temperature of water in the second bucket is [ ] &#x2103. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "morevar", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/MOREVAR/morevar6.html
p = Problem.create!(filename: 'morevar6.html', curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', text: "<p>A\r\n boat travels a certain distance downstream in 2 hours 55 minutes and \r\nthe same distance upstream in 3 hours and 45 minutes. How\r\nlong would it take for a boat  that travels half that fast with\r\nrespect to the river to travel the same distance downstream?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "5|15", interface: "[ ] hours and [ ] minutes. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "morevar", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/MOREVAR/morevar18.html
p = Problem.create!(filename: 'morevar18.html', curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', text: "<p>\r\nTwo race cars start at the same point of a 3 mile circuit\r\nand travel with constant speeds. If they travel in the same direction, they meet again in 9 minutes. If they travel in\r\nopposite directions, they  meet 27 seconds. What are the velocities\r\nof the cars, in miles per hour?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "210|190", interface: "The velocity of the faster car is [ ] mph, the velocity of the slower car is [ ] mph. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "morevar", diff: 4, source: "Examen de admitere, Deva, 1958")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/MOREVAR/morevar17.html
p = Problem.create!(filename: 'morevar17.html', curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', text: "<p>Jerry told Mary: &ldquo;I have now twice the age that you had when I was your age, and when you will be my age, I will be missing 8 years to be twice your present age.&rdquo; How old are Jerry\r\nand Mary? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "32|24", interface: "Jerry is [ ] years old, and Mary is [ ] years old. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "morevar", diff: 2, source: "Gheba, modified")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/MOREVAR/morevar10.html
p = Problem.create!(filename: 'morevar10.html', curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', text: "<p>\r\nIn two boxes there are balls. If we moved one ball from the first\r\nbox to the second, both would have the same number of balls. If\r\nwe moved two balls from the first box to the second, the first box would contain twice as many balls as the second. How many\r\nballs are in each? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "10|8", interface: "In the first box there are [ ] balls, in the second there are [ ] balls. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "morevar", diff: 1, source: "judeteana Buzau, a VI-a, 1994, Apostol Constantin")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/MOREVAR/morevar13.html
p = Problem.create!(filename: 'morevar13.html', curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', text: "<p>\r\nThere are cherries and strawberries in a basket. If you\r\nadd 34 cherries and 20 strawberries, then the cherries\r\nmake up \\(\\frac{3}{7}\\) of the total amount. If you\r\ntake away 6 cherries and 3 strawberries, then the cherries\r\nmake up \\(\\frac{5}{16}\\) of the total amount. How many cherries\r\nand how many strawberries are there in the basket?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "41|80", interface: "There are [ ] cherries and [ ] strawberries in the basket. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "morevar", diff: 3, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/MOREVAR/morevar23.html
p = Problem.create!(filename: 'morevar23.html', curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', text: "<p> We divide a certain amount of money among several people.\r\nIf there were 6 more people, each would get 20 dollars less. If\r\nthere were 4 less people, each would get 30 dollars more. How much\r\nmoney is there to be divided?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "720", interface: "The amount of money is [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "morevar", diff: 3, source: "Gheba, modified")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/MOREVAR/morevar15.html
p = Problem.create!(filename: 'morevar15.html', curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', text: "<p>\r\nThe ratio of the numbers of cattle in two ranches is \\(\\frac{5}{6}\\).  After the first ranch sold 1400 cows and the second 600, the\r\nratio of the numbers of cattle in those ranches has become \r\n\\(\\frac{2}{3}\\). How many cows are now left on each ranch? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "3600|5400", interface: "The first ranch now has [ ] cows, the second ranch has [ ] cows. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "morevar", diff: 2, source: "Gheba")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/MOREVAR/morevar14.html
p = Problem.create!(filename: 'morevar14.html', curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', text: "<p>\r\nTwo rolls of the same fabric are worth first 238 dollars and the second\r\n182 dollars. If the price of a yard of fabric were reduced by\r\n2 dollars, the first piece would cost 48 dollars more than the\r\nsecond. How many yards\r\nhas each of the rolls?  What does one yard of fabric cost? \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "17|13|14", interface: "The first roll has [ ] yards, the second roll has [ ] yards. One yard of fabric costs [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "morevar", diff: 3, source: "Examen de admitere, Baia Mare, 1956")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/MOREVAR/morevar19.html
p = Problem.create!(filename: 'morevar19.html', curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', text: "<p>\r\nTwo bikers left at the same time one towards the other from\r\ntwo cities at a distance of 38 kilometers from each other. \r\nThe first biker traveled for an hour and a half, and then\r\nwaited for the second biker. The second biker arrived after\r\nhalf an hour. At some other time they also traveled towards\r\neach other on the same road, and after one hour and 15 minutes\r\nthe distance between them was 10.5 kilometers. What is\r\nthe traveling speed of each biker?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "12|10", interface: "The traveling speed of the first biker is [ ] kilometers per hour, and the traveling speed of the second biker is [ ] kilometers per hour. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "morevar", diff: 2, source: "Gheba")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/MOREVAR/morevar24.html
p = Problem.create!(filename: 'morevar24.html', curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', text: "<p> A cargo plane is by 300 km/h slower than a passenger plane, and\r\n by 450 km/h slower than a military plane. \r\nTo travel the distance between two airports, the passenger\r\nplane needs 3 hours less than the cargo plane, and 1 hour more\r\nthan the military plane. What are the velocities of the three\r\nplanes?  \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "900|1200|1350", interface: "The velocity of the cargo plane is [ ] km/h, that of the passenger plane is [ ] km/h, and that of the military plane is [ ] km/h. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "morevar", diff: 2, source: "Gheba, modified")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/MOREVAR/morevar21.html
p = Problem.create!(filename: 'morevar21.html', curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', text: "<p>\r\nLucy bought 10 apples, 15 pears, and 7 pineapples for $41. \r\nAnn bought 14 apples, 21 pears, and 5 peaches for $43. How\r\nmuch do 6 apples and 9 pears cost?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "12", interface: "6 apples and 9 pears cost [ ] dollars. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "morevar", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/MOREVAR/morevar26.html
p = Problem.create!(filename: 'morevar26.html', curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', text: "<p> \r\nThe average age of the 7  people in a room is\r\n36 years. Two people left the room. Now the average age\r\nis 39 years. How old are   the people  who left the room if one\r\nis by 5 years older than the other?\r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "31|26", interface: "The older person is [ ] years old, the younger is [ ] years old. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "morevar", diff: 6, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/MOREVAR/morevar22.html
p = Problem.create!(filename: 'morevar22.html', curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', text: "<p>\r\nA number of trucks must move a certain load in a\r\ncertain amount of time. If there were 2 trucks less,\r\nthe moving would end 2 hours after the scheduled time.\r\nIf there were 4 trucks more, the moving would end\r\n2 hours before the scheduled time. How many trucks and\r\nhours were\r\nplanned for the scheduled move. \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "8|6", interface: "There were [ ] trucks and [ ] hours planned. ")
#SOLUTION TUPLE FOR PROBLEM P
...
#METADATA TUPLE FOR PROBLEM P
p.metadata = Metadata.new(curriculum: "lifetomath", category: "algebraic", context: "morevar", diff: 2, source: "source")
#PROBLEM TUPLE FOR /home/lancaster/Documents/persProj/ma_files/LIFETOMATH/ALGEBRAIC/MOREVAR/morevar5.html
p = Problem.create!(filename: 'morevar5.html', curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', text: "<p>The money of the country Miranda has only\r\nbills of denominations of $19 and $21. A person wants to buy \r\na laptop worth $359 at a vending machine that requires exact change. Can this be done?   \r\n</p>\r\n")
#ANSWER TUPLE FOR PROBLEM P
p.answer = Answer.new(values: "0", interface: "Enter 1 for yes, 0 for no. The answer is [ ]. ")
#SOLUTION TUPLE FOR PROBLEM P
...
Globalgraph.create!(curriculum: 'lifetomath', category: 'introduction', context: 'category_introduction', category_order: 0, context_order: 0)
Globalgraph.create!(curriculum: 'lifetomath', category: 'introduction', context: 'examples', category_order: 0, context_order: 1)
Globalgraph.create!(curriculum: 'lifetomath', category: 'methods', context: 'category_introduction', category_order: 1, context_order: 0)
Globalgraph.create!(curriculum: 'lifetomath', category: 'methods', context: 'numerical', category_order: 1, context_order: 1)
Globalgraph.create!(curriculum: 'lifetomath', category: 'methods', context: 'graphical', category_order: 1, context_order: 2)
Globalgraph.create!(curriculum: 'lifetomath', category: 'methods', context: 'comparison', category_order: 1, context_order: 3)
Globalgraph.create!(curriculum: 'lifetomath', category: 'methods', context: 'proportions', category_order: 1, context_order: 4)
Globalgraph.create!(curriculum: 'lifetomath', category: 'methods', context: 'backwards', category_order: 1, context_order: 5)
Globalgraph.create!(curriculum: 'lifetomath', category: 'methods', context: 'falsehyp', category_order: 1, context_order: 6)
Globalgraph.create!(curriculum: 'lifetomath', category: 'methods', context: 'casetry', category_order: 1, context_order: 7)
Globalgraph.create!(curriculum: 'lifetomath', category: 'applications', context: 'category_introduction', category_order: 2, context_order: 0)
Globalgraph.create!(curriculum: 'lifetomath', category: 'applications', context: 'quantities', category_order: 2, context_order: 1)
Globalgraph.create!(curriculum: 'lifetomath', category: 'applications', context: 'money', category_order: 2, context_order: 2)
Globalgraph.create!(curriculum: 'lifetomath', category: 'applications', context: 'time', category_order: 2, context_order: 3)
Globalgraph.create!(curriculum: 'lifetomath', category: 'applications', context: 'motion', category_order: 2, context_order: 4)
Globalgraph.create!(curriculum: 'lifetomath', category: 'applications', context: 'percentages', category_order: 2, context_order: 5)
Globalgraph.create!(curriculum: 'lifetomath', category: 'applications', context: 'liquids', category_order: 2, context_order: 6)
Globalgraph.create!(curriculum: 'lifetomath', category: 'applications', context: 'average', category_order: 2, context_order: 7)
Globalgraph.create!(curriculum: 'lifetomath', category: 'algebraic', context: 'category_introduction', category_order: 3, context_order: 0)
Globalgraph.create!(curriculum: 'lifetomath', category: 'algebraic', context: 'onevar', category_order: 3, context_order: 1)
Globalgraph.create!(curriculum: 'lifetomath', category: 'algebraic', context: 'morevar', category_order: 3, context_order: 2)
Globalgraph.create!(curriculum: 'lifetomath', category: 'algebraic', context: 'cancel', category_order: 3, context_order: 3)
